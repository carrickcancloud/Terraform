...
#
# This script is part of the AMI building process. It downloads the latest
# WordPress, validates its version against a pinned major version, and creates
# separate deployment packages (web tier static content, app tier core files)
# that Packer will then bake into the AMIs.
#
...
# The 'dist' directory will be created at the root of the workspace.
