# ==============================================================================
# Project Anvil - Application Layer (QA Environment)
# environments/qa.tfvars
#
# This file defines the environment-specific input variables for the 'qa'
# application layer. These values configure scaling, instance types, and
# AMI versions for the quality assurance environment.
#
...
# ------------------------------------------------------------------------------
# Deploys 'qa' across three Availability Zones.
...
# ------------------------------------------------------------------------------
key_name = "acmelabs-qa-key"

# ------------------------------------------------------------------------------
# Scaling Parameters
# Defines the scaling parameters for each tier.
# ------------------------------------------------------------------------------
web_min_size         = 2
web_max_size         = 4
